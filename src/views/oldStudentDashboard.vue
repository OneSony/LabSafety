<template>
  <div class="dashboard">
    ...
    <div v-if="selectedClass">
      <ClassPanel :class="selectedClass" />
    </div>
  </div>
</template>
...
export default {
  ...
  components: { SidebarMenu, CourseCard, PaginationComponent, ClassPanel },
  data() {
    return {
      activeTab: "all",
      allExperiments: [],
      ...
      totalExperiments: 0,
      selectedClass: null, // 用于存储选中的class
    };
  },
  mounted() {
  ...
  methods: {
    ...
    showClassPanel(classItem) {
      console.log("Show class panel:", classItem);
      this.selectedClass = classItem; // 更新选中的 class
    },
  },
};
</script>
